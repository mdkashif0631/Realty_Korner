  ...
  return (
    <div className='locality-container'>
        <div className='locality-items'>
            <img className='area-image' src={project.Location_Map ? `${BASE_URL}/uploads/${project.Location_Map}`: '../img/RealtyKornerLogo.png'}  alt="Floor Plan" />
            <img className='google-map' src={project.Google_Map ? `${BASE_URL}/uploads/${project.Google_Map}`: '../img/RealtyKornerLogo.png'} alt="Floor Plan" />
        </div>
