        ...
        <div className="project_content_box">
            <div className={`project_header ${isSticky ? 'sticky' : ''}`}>
                <div className="header-left">
                    <img
                        src={project.Developer_Logo ? `${BASE_URL}/uploads/${project.Developer_Logo}` : '../img/RealtyKornerLogo.png'}
                        alt="Project Logo"
                ...
                <div className="header-right">
                    <img
                        src={project.Logoimg ? `${BASE_URL}/uploads/${project.Logoimg}` : '../img/RealtyKornerLogo.png'}
                ...
                <div className='right-all-part'>
                    <div className="enquire-contact-form-container">
                        <div className="contact-companies">
                            <img src={project.Developer_Logo ? `${BASE_URL}/uploads/${project.Developer_Logo}` : '../img/RealtyKornerLogo.png'}
