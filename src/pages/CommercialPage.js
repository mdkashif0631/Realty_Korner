...
const CommercialPage = () => {
  ...
  const images = [
    project?.Main_Image
      ? `${BASE_URL}/uploads/${project.Main_Image}`
      : "/img/placeholder-image.jpg",
    project?.Image
      ? `${BASE_URL}/uploads/${project.Image}`
      : "/img/placeholder-image.jpg",
    project?.Image01
      ? `${BASE_URL}/uploads/${project.Image01}`
      : "/img/placeholder-image.jpg",
    project?.Image02
      ? `${BASE_URL}/uploads/${project.Image02}`
      : "/img/placeholder-image.jpg",
    project?.Image03
      ? `${BASE_URL}/uploads/${project.Image03}`
      : "/img/placeholder-image.jpg",
    project?.Image04
      ? `${BASE_URL}/uploads/${project.Image04}`
      : "/img/placeholder-image.jpg",
  ];
            ...
            <img
              src={
                project?.Developer_Logo
                  ? `${BASE_URL}/uploads/${project.Developer_Logo}`
                  : "/img/placeholder-image.jpg"
              }
              alt="logo"
            />
