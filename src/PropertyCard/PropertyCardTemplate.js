  ...
  <Card className="cardContainer mb-4">
    <div className='stickerimages' style={{ height: '200px', position: 'relative' }}>
      <Card.Img
        ...
        variant="top"
        src={property.Main_Image ? `${BASE_URL}/uploads/${property.Main_Image}` : '../img/img1.jpg'}
        alt="Property"
      ...
      <div className='logoImage'>
        <img
          src={property.Developer_Logo ? `${BASE_URL}/uploads/${property.Developer_Logo}` : '../img/img1.png'}
          alt="logo"
