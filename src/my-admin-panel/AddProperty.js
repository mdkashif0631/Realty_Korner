...
const AddProperty = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Group amenities by category before appending
    ...
    Object.entries(formData).forEach(([key, val]) => {
      if (key === "Amenities") return; // already appended
      ...
      case 1:
        return (
          <div>
            ...
            <select name="Project_tag" onChange={handleChange} value={formData.Project_tag}>
              <option value="">Select Option</option>
              <option>New Launch</option>
              <option>Upcoming Project</option>
              <option>Under Constrution</option>
